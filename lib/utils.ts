...
export const formatArticle = (
  ...
  source: article.source || (isCompanyNews ? 'Noticias de la empresa' : 'Noticias del mercado'),
  url: article.url!,
...
export const formatDateToday = new Date().toLocaleDateString('es-AR', {
  weekday: 'long',
  year: 'numeric',
  month: 'long',
  day: 'numeric',
...
export const getAlertText = (alert: Alert) => {
  ...
  return `Precio ${condition} ${formatPrice(alert.threshold)}`;
};

export const getFormattedTodayDate = () => new Date().toLocaleDateString('es-AR', {
  weekday: 'long',
  year: 'numeric',
  month: 'long',
  day: 'numeric',
